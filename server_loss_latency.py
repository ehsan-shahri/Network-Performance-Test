...
Date: 2024-11-01
Version: 2.0
Description: This script evaluate the performance of Wi-Fi 7 networks in case of packet loss and latency. This code runs on a server to capture the maximum number of UDP packets sent from a client to mesure the packet loss and latency metrics. 
"""
